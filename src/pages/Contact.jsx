          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div>
              ...
              <input type="text" required value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })}
                className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-5 py-4 text-sm outline-none focus:border-cyan-500 focus:bg-cyan-50 transition-all text-zinc-800" placeholder="Enter Your Name" />
            </div>
            <div>
              ...
              <input type="email" required value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })}
                className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-5 py-4 text-sm outline-none focus:border-cyan-500 focus:bg-cyan-50 transition-all text-zinc-800" placeholder="Enter Your Email" />
            </div>
            <div>
              ...
              <textarea required value={formData.message} onChange={e => setFormData({ ...formData, message: e.target.value })} rows={5}
                className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-5 py-4 text-sm outline-none resize-none focus:border-cyan-500 focus:bg-cyan-50 transition-all custom-scrollbar text-zinc-800" placeholder="Enter Your Message" />
            </div>

            <button type="submit" disabled={loading || submitted}
              className={`w-full mt-2 py-4 rounded-xl font-black text-sm uppercase tracking-widest transition-all flex justify-center items-center gap-2 ${submitted ? 'bg-green-500 border border-green-400 text-zinc-800 shadow-[0_0_20px_rgba(34,197,94,0.4)]' :
